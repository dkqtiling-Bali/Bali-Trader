...
$state=Join-Path $Root 'game_arena\guardian\BOT_GUARDIAN_STATE_V012I.json'
$report=Join-Path $logs 'BALI_BOT_GUARDIAN_STATUS_V012I.txt'
Set-Content -LiteralPath $report -Encoding ASCII -Value @(
  'BALI BOT GUARDIAN STATUS V012I',
  ('Generated: '+(Get-Date)),
