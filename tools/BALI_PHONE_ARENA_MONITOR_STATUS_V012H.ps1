...
$status=Join-Path $Root 'game_arena\phone_monitor\PHONE_MONITOR_STATUS_V012H.json'
$report=Join-Path $logs 'BALI_PHONE_ARENA_MONITOR_STATUS_V012H.txt'
$ip='YOUR-PC-LAN-IP'
try {
...
Set-Content -LiteralPath $report -Encoding ASCII -Value @(
  'BALI PHONE ARENA MONITOR STATUS V012H',
  ('Generated: '+(Get-Date)),
