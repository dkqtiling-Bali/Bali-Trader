...
if(Test-Path -LiteralPath (Join-Path $rootPath 'tools\BALI_ONE_CLICK_UPDATE_ENGINE_V011P.ps1')) { Add 'UPDATE_ENGINE_V011P=FOUND' } else { Add 'UPDATE_ENGINE_V011P=MISSING' }
...
if(Test-Path -LiteralPath (Join-Path $rootPath 'tools\BALI_ROOT_GUARD_V011P.ps1')) { Add 'ROOT_GUARD_V011P=FOUND' } else { Add 'ROOT_GUARD_V011P=MISSING' }
...
if(Test-Path -LiteralPath (Join-Path $rootPath 'tools\BALI_DASH_UPDATE_RESTART_ENGINE_V011P.ps1')) { Add 'DASH_RESTART_ENGINE_V011P=FOUND' } else { Add 'DASH_RESTART_ENGINE_V011P=MISSING' }




$iconL = Join-Path $rootPath 'assets\BALI_FOREVER_THEME_ICON_V011P.ico'
...
if(Test-Path -LiteralPath $iconL -PathType Leaf) { Add 'BALI_THEMED_ICON=FOUND_V011P' }
...
if(Test-Path -LiteralPath (Join-Path $rootPath 'tools\BALI_LAUNCH_BAY_CLEANUP_V011P.ps1')) { Add 'LAUNCH_BAY_CLEANUP_ENGINE_V011P=FOUND' } else { Add 'LAUNCH_BAY_CLEANUP_ENGINE_V011P=MISSING' }
