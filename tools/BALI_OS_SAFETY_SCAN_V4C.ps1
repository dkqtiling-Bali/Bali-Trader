...
$excludeDirs = @(".git", "__pycache__", "node_modules", ".venv", "venv", "BACKUPS")
...
# These aim to catch real secrets, not policy text.
$hardSecretRegexes = @(
...
$reportPath = Join-Path $reportDir ("BALI_SAFETY_SCAN_V4C_" + $stamp + ".txt")

$body = New-Object System.Collections.Generic.List[string]
$body.Add("BALI SAFETY SCAN V4C")
...
return [pscustomobject]@{ Status=$status; Report=$reportPath; BlockCount=$blocks.Count }
