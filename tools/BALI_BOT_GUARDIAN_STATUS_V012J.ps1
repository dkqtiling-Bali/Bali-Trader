...
$state=Join-Path $Root 'game_arena\guardian\BOT_GUARDIAN_STATE_V012J.json'
$report=Join-Path $logs 'BALI_BOT_GUARDIAN_STATUS_V012J.txt'
Set-Content -LiteralPath $report -Encoding ASCII -Value @(
  'BALI BOT GUARDIAN STATUS V012J',
  ('Generated: '+(Get-Date)),
