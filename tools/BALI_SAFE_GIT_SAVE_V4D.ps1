...
Write-Host "=========================================="
Write-Host "        BALI SAFE GIT SAVE V4D"
Write-Host "=========================================="
Write-Host "SAFE_TOOLING_ONLY"
Write-Host "No app.py edit. No trading logic change. No live trading. No keys."
Write-Host ""

$scanScript = Join-Path $Base "tools\BALI_OS_SAFETY_SCAN_V4D.ps1"
if (-not (Test-Path -LiteralPath $scanScript)) { throw "Missing V4D safety scan script: $scanScript" }
