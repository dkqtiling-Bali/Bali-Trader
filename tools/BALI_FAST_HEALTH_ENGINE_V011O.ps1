...
if(Test-Path -LiteralPath (Join-Path $rootPath 'tools\BALI_ONE_CLICK_UPDATE_ENGINE_V011O.ps1')) { Add 'UPDATE_ENGINE_V011O=FOUND' } else { Add 'UPDATE_ENGINE_V011O=MISSING' }
...
if(Test-Path -LiteralPath (Join-Path $rootPath 'tools\BALI_ROOT_GUARD_V011O.ps1')) { Add 'ROOT_GUARD_V011O=FOUND' } else { Add 'ROOT_GUARD_V011O=MISSING' }
...
if(Test-Path -LiteralPath (Join-Path $rootPath 'tools\BALI_DASH_UPDATE_RESTART_ENGINE_V011O.ps1')) { Add 'DASH_RESTART_ENGINE_V011O=FOUND' } else { Add 'DASH_RESTART_ENGINE_V011O=MISSING' }




$iconL = Join-Path $rootPath 'assets\BALI_FOREVER_THEME_ICON_V011O.ico'
...
if(Test-Path -LiteralPath $iconL -PathType Leaf) { Add 'BALI_THEMED_ICON=FOUND_V011O' }
...
if(Test-Path -LiteralPath (Join-Path $rootPath 'tools\BALI_LAUNCH_BAY_CLEANUP_V011O.ps1')) { Add 'LAUNCH_BAY_CLEANUP_ENGINE_V011O=FOUND' } else { Add 'LAUNCH_BAY_CLEANUP_ENGINE_V011O=MISSING' }
