BALI ROCKET CRYPTO COMMAND V011H - UPDATER RESCUE + HEALTH CHECK
...
- V011H repairs the picker and refuses blank/non-file ZIP paths before extraction.

What this patch includes
- Fixed BALI_ONE_CLICK_UPDATE.bat.
- New tools/BALI_ONE_CLICK_UPDATE_ENGINE_V011H.ps1.
- Health check layer from V011G, versioned forward to V011H.
- Startup reports versioned to V011H.
...
1. Extract the V011H rescue kit into the Bali root folder.
2. Double-click BALI_ONE_CLICK_UPDATE_RESCUE_V011H.bat.
3. It will apply the V011H patch zip from the same folder.

Option B - manual fallback:
1. Open this V011H patch zip.
...
- Startup report: BALI ROCKET V011H READY
