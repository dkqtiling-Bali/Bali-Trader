...
title Bali Launch Bay Cleanup V012J
...
set "REPORT=%LOGDIR%\BALI_LAUNCH_BAY_CLEANUP_REPORT_V012J.txt"

set "ENGINE=%ROOT%\tools\BALI_LAUNCH_BAY_CLEANUP_V012J.ps1"
...
(
  ...
  echo BALI LAUNCH BAY CLEANUP REPORT V012J

  echo Generated: %DATE% %TIME%

  echo Root folder: %ROOT%

  echo RESULT: CLEANUP ENGINE MISSING
