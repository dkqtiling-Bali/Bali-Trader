...
def ensure_dirs() -> None:
    for p in [SHARED, LOGS, REPORTS, UPDATES, STRATEGIES, GRAVEYARD, UPDATE_INBOX, BACKUPS, RELEASES, SHARED / "candles", SHARED / "paper_shadow", SHARED / "universe", SHARED / "backtests"]:
...
def read_autopilot_state(parent: Optional[Path] = None) -> Dict[str, Any]:
    ...
    if not isinstance(data, dict):
        data = default
    # V012K defaults to armed unless user pauses it.
